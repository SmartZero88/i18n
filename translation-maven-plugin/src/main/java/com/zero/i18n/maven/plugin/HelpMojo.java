...
/**
 * Display help information on i18n-maven-plugin.<br/>
 * Call <code>mvn i18n-maven-plugin:help -Ddetail=true -Dgoal=&lt;goal-name&gt;</code> to
...
public class HelpMojo
    ...
    private static final String PLUGIN_HELP_PATH =
        "/META-INF/maven/com.zero.i18n.maven.plugin/i18n-maven-plugin/plugin-help.xml";
    ...
    public void execute()
        ...
        String id = getValue(plugin, "groupId")
            + ":" + getValue(plugin, "artifactId") + ":" + version;
        ...
        if (goal == null || goal.length() <= 0) {
            append(
                sb, "This plugin has " + mojos.size() + (mojos.size() > 1 ? " goals:" : " goal:"),
                0);
            append(sb, "", 0);
        }
    ...
    private Node getSingleChild(Node node, String elementName)
        ...
        if (namedChild.isEmpty()) {
            throw new MojoExecutionException(
                "Could not find " + elementName + " in plugin-help.xml");
        }
    ...
    private void writeParameter(StringBuilder sb, Node parameter, Node configurationElement)
        ...
        if (fieldConfigurationElement != null && fieldConfigurationElement.getNodeValue() != null) {
            parameterDefaultValue = " (Default: "
                + ((Element) fieldConfigurationElement).getAttribute("default-value") + ")";
        }
